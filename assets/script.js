...
function getData() { // my api code
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=8af713bebedab909ba40e0054699acdb" // starts call for current conditions
    mainCard.empty();
    ...
    $.ajax({
        ...
        $.ajax({
            url: "https://api.openweathermap.org/data/2.5/uvi?appid=8af713bebedab909ba40e0054699acdb&lat=" + lat + "&lon=" + lon, // my api code
            method: "GET"
